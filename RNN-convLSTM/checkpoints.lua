...
function checkpoint.latest(opt)
   ...
   --resumeFile default ='latest_best',  'file for resuming training: latest_best | latest_current'
   local latestPath = paths.concat(opt.resume, latestFile)
   print(latestPath..'&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&')
  --resume  = 'Path to directory containing checkpoint'
...
function checkpoint.save(epoch, model, optimState, bestModel, bestTop1)
   ...
   local modelFile = 'rnn_model-yww.t7'
